...
class UserDataResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "7@o&.icd~y\"";
    private static final String UPDATED_EMAIL = "'C@OA%%\\.lv'";
    ...
    void createUserData() throws Exception {
        ...
        assertThat(testUserData.getSurname()).isEqualTo(DEFAULT_SURNAME);
    ...
    @Test
    @Transactional
    void getAllUserDataByNameIsEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where name equals to DEFAULT_NAME
        defaultUserDataShouldBeFound("name.equals=" + DEFAULT_NAME);

        // Get all the userDataList where name equals to UPDATED_NAME
        defaultUserDataShouldNotBeFound("name.equals=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllUserDataByNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where name not equals to DEFAULT_NAME
        defaultUserDataShouldNotBeFound("name.notEquals=" + DEFAULT_NAME);

        // Get all the userDataList where name not equals to UPDATED_NAME
        defaultUserDataShouldBeFound("name.notEquals=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllUserDataByNameIsInShouldWork() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where name in DEFAULT_NAME or UPDATED_NAME
        defaultUserDataShouldBeFound("name.in=" + DEFAULT_NAME + "," + UPDATED_NAME);

        // Get all the userDataList where name equals to UPDATED_NAME
        defaultUserDataShouldNotBeFound("name.in=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllUserDataByNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where name is not null
        defaultUserDataShouldBeFound("name.specified=true");

        // Get all the userDataList where name is null
        defaultUserDataShouldNotBeFound("name.specified=false");
    }

    @Test
    @Transactional
    void getAllUserDataByNameContainsSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where name contains DEFAULT_NAME
        defaultUserDataShouldBeFound("name.contains=" + DEFAULT_NAME);

        // Get all the userDataList where name contains UPDATED_NAME
        defaultUserDataShouldNotBeFound("name.contains=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllUserDataByNameNotContainsSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where name does not contain DEFAULT_NAME
        defaultUserDataShouldNotBeFound("name.doesNotContain=" + DEFAULT_NAME);

        // Get all the userDataList where name does not contain UPDATED_NAME
        defaultUserDataShouldBeFound("name.doesNotContain=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    void getAllUserDataBySurnameIsEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where surname equals to DEFAULT_SURNAME
        defaultUserDataShouldBeFound("surname.equals=" + DEFAULT_SURNAME);

        // Get all the userDataList where surname equals to UPDATED_SURNAME
        defaultUserDataShouldNotBeFound("surname.equals=" + UPDATED_SURNAME);
    }

    @Test
    @Transactional
    void getAllUserDataBySurnameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where surname not equals to DEFAULT_SURNAME
        defaultUserDataShouldNotBeFound("surname.notEquals=" + DEFAULT_SURNAME);

        // Get all the userDataList where surname not equals to UPDATED_SURNAME
        defaultUserDataShouldBeFound("surname.notEquals=" + UPDATED_SURNAME);
    }

    @Test
    @Transactional
    void getAllUserDataBySurnameIsInShouldWork() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where surname in DEFAULT_SURNAME or UPDATED_SURNAME
        defaultUserDataShouldBeFound("surname.in=" + DEFAULT_SURNAME + "," + UPDATED_SURNAME);

        // Get all the userDataList where surname equals to UPDATED_SURNAME
        defaultUserDataShouldNotBeFound("surname.in=" + UPDATED_SURNAME);
    }

    @Test
    @Transactional
    void getAllUserDataBySurnameIsNullOrNotNull() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where surname is not null
        defaultUserDataShouldBeFound("surname.specified=true");

        // Get all the userDataList where surname is null
        defaultUserDataShouldNotBeFound("surname.specified=false");
    }

    @Test
    @Transactional
    void getAllUserDataBySurnameContainsSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where surname contains DEFAULT_SURNAME
        defaultUserDataShouldBeFound("surname.contains=" + DEFAULT_SURNAME);

        // Get all the userDataList where surname contains UPDATED_SURNAME
        defaultUserDataShouldNotBeFound("surname.contains=" + UPDATED_SURNAME);
    }

    @Test
    @Transactional
    void getAllUserDataBySurnameNotContainsSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where surname does not contain DEFAULT_SURNAME
        defaultUserDataShouldNotBeFound("surname.doesNotContain=" + DEFAULT_SURNAME);

        // Get all the userDataList where surname does not contain UPDATED_SURNAME
        defaultUserDataShouldBeFound("surname.doesNotContain=" + UPDATED_SURNAME);
    }

    @Test
    @Transactional
    void getAllUserDataByEmailIsEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where email equals to DEFAULT_EMAIL
        defaultUserDataShouldBeFound("email.equals=" + DEFAULT_EMAIL);

        // Get all the userDataList where email equals to UPDATED_EMAIL
        defaultUserDataShouldNotBeFound("email.equals=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    void getAllUserDataByEmailIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where email not equals to DEFAULT_EMAIL
        defaultUserDataShouldNotBeFound("email.notEquals=" + DEFAULT_EMAIL);

        // Get all the userDataList where email not equals to UPDATED_EMAIL
        defaultUserDataShouldBeFound("email.notEquals=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    void getAllUserDataByEmailIsInShouldWork() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where email in DEFAULT_EMAIL or UPDATED_EMAIL
        defaultUserDataShouldBeFound("email.in=" + DEFAULT_EMAIL + "," + UPDATED_EMAIL);

        // Get all the userDataList where email equals to UPDATED_EMAIL
        defaultUserDataShouldNotBeFound("email.in=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    void getAllUserDataByEmailIsNullOrNotNull() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where email is not null
        defaultUserDataShouldBeFound("email.specified=true");

        // Get all the userDataList where email is null
        defaultUserDataShouldNotBeFound("email.specified=false");
    }

    @Test
    @Transactional
    void getAllUserDataByEmailContainsSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where email contains DEFAULT_EMAIL
        defaultUserDataShouldBeFound("email.contains=" + DEFAULT_EMAIL);

        // Get all the userDataList where email contains UPDATED_EMAIL
        defaultUserDataShouldNotBeFound("email.contains=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    void getAllUserDataByEmailNotContainsSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);

        // Get all the userDataList where email does not contain DEFAULT_EMAIL
        defaultUserDataShouldNotBeFound("email.doesNotContain=" + DEFAULT_EMAIL);

        // Get all the userDataList where email does not contain UPDATED_EMAIL
        defaultUserDataShouldBeFound("email.doesNotContain=" + UPDATED_EMAIL);
    }
    ...
    @Test
    @Transactional
    void getAllUserDataByUserNameIsEqualToSomething() throws Exception {
        // Initialize the database
        userDataRepository.saveAndFlush(userData);
        UserName userName;
        ...
        // Get all the userDataList where userName equals to userNameId
        defaultUserDataShouldBeFound("userNameId.equals=" + userNameId);

        // Get all the userDataList where userName equals to (userNameId + 1)
        defaultUserDataShouldNotBeFound("userNameId.equals=" + (userNameId + 1));
    }
    ...
    void putNewUserData() throws Exception {
        ...
        assertThat(testUserData.getSurname()).isEqualTo(UPDATED_SURNAME);
    ...
    void partialUpdateUserDataWithPatch() throws Exception {
        ...
        partialUpdatedUserData.name(UPDATED_NAME).birthDate(UPDATED_BIRTH_DATE).addDate(UPDATED_ADD_DATE);
