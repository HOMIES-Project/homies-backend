...
describe('UserPending Management Component', () => {
  let comp: UserPendingComponent;
  let fixture: ComponentFixture<UserPendingComponent>;
  let service: UserPendingService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'user-pending', component: UserPendingComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(UserPendingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userPendings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
