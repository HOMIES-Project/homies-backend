...
export class GroupUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    groupKey: [null, [Validators.required, Validators.minLength(10)]],
    groupPassword: [null, [Validators.required, Validators.minLength(8)]],
  ...
  protected createFromForm(): IGroup {
    return {
      ...
      groupPassword: this.editForm.get(['groupPassword'])!.value,
