...
export class SpendingComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.spendingService
      ...
      .subscribe({
        next: (res: HttpResponse<ISpending[]>) => {
  ...
  trackId(index: number, item: ISpending): number {
    return item.id!;
  }
  ...
  delete(spending: ISpending): void {
  ...
  protected onSuccess(data: ISpending[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
