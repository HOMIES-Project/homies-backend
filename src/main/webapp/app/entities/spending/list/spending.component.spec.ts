...
describe('Spending Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'spending', component: SpendingComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.spendings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
