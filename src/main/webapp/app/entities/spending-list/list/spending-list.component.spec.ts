...
describe('SpendingList Management Component', () => {
  let comp: SpendingListComponent;
  let fixture: ComponentFixture<SpendingListComponent>;
  let service: SpendingListService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'spending-list', component: SpendingListComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SpendingListComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.spendingLists?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
